...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="w-full bg-[#050505] border-t border-[#00E5FF]/20 py-10 mt-16 relative overflow-hidden">
      ...
      {/* Ambient footer glow */}
      <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#00E5FF]/10 to-transparent pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-8 border-b border-[#00E5FF]/15">
          
          {/* Left: College Logo & Name */}
          <div className="flex items-center gap-3.5">
            <div className="w-12 h-12 rounded-full p-0.5 bg-gradient-to-tr from-[#00E5FF] via-[#D4AF37] to-[#00C8A8] shadow-[0_0_15px_rgba(0,229,255,0.35)] flex items-center justify-center overflow-hidden">
              <img
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              rel="noreferrer"
              title="Facebook"
              className="w-9 h-9 rounded-full bg-[#050505] border border-[#00E5FF]/30 flex items-center justify-center text-gray-300 hover:text-white hover:border-[#00E5FF] hover:scale-110 transition-all shadow-[0_0_10px_rgba(0,229,255,0.2)]"
            >

...
export const StudentListPage: React.FC<StudentListPageProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-10 space-y-6 sm:space-y-8">
      ...
      {/* ================= COUNTDOWN TIMER ================= */}
      <div className="w-full bg-gradient-to-r from-[#120D24] via-[#1A1230] to-[#120D24] rounded-2xl border border-purple-600/40 p-4 sm:p-6 md:p-8 shadow-[0_0_35px_rgba(109,40,217,0.3)] text-center relative overflow-hidden">
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-4 max-w-xl mx-auto gap-2 sm:gap-4 mt-4 sm:mt-6">
            {[
              ...
              <div
                key={box.label}
                className="bg-[#0B0914]/90 border-2 border-purple-500/50 rounded-xl p-2 xs:p-2.5 sm:p-4 shadow-[0_0_20px_rgba(109,40,217,0.4)] flex flex-col items-center justify-center group hover:border-[#FBBF24] transition-all"
              >
                <span className="font-teko text-2xl xs:text-3xl sm:text-5xl md:text-6xl font-bold text-white tracking-wider leading-none group-hover:text-[#FBBF24] transition-colors">
      ...
      <div className="flex items-center">
        <div className="bg-[#111111] border border-purple-900/50 rounded-xl p-3.5 sm:p-5 shadow-[0_0_20px_rgba(109,40,217,0.15)] flex items-center gap-3 sm:gap-4 min-w-[200px] sm:min-w-[240px]">
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-purple-950/60 border border-purple-700/60 flex items-center justify-center text-purple-400 shrink-0">
      ...
      <div className="bg-[#111111] border border-purple-700/40 rounded-2xl p-4 sm:p-5 shadow-[0_0_30px_rgba(109,40,217,0.2)] space-y-3 sm:space-y-4">
        ...
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full bg-[#16161F] border border-purple-900/50 focus:border-[#6D28D9] rounded-xl pl-10 pr-4 py-2 sm:py-2.5 text-xs sm:text-sm text-white placeholder-gray-500 outline-none transition"
          />
        </div>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-purple-900/30">
          <div className="flex items-center gap-2 text-xs sm:text-sm">
            ...
            <select
              ...
              className="bg-[#181822] border border-purple-900/50 text-white rounded-md px-2.5 sm:px-3 py-1 sm:py-1.5 outline-none font-semibold focus:border-purple-500 transition text-xs sm:text-sm"
            >
          ...
          filteredList.map(student => {
            ...
            return (
              <div
                ...
                className="bg-[#111111] rounded-xl border border-purple-800/40 p-3.5 shadow-md active:scale-[0.99] transition-all cursor-pointer"
              >
                <div className="flex items-start gap-3">
                  <img
                    src={student.photoUrl}
                    alt={student.fullName}
                    className="w-12 h-12 rounded-full object-cover border border-[#FBBF24]/60 shrink-0"
                  />
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 mt-2">
                      ...
                      <span className="px-2 py-0.5 rounded bg-[#1C162E] text-[#FBBF24] font-bold text-[10px] border border-purple-700/50">
      ...
      <div className="hidden md:block bg-[#111111] rounded-2xl border border-purple-700/40 shadow-[0_0_35px_rgba(109,40,217,0.2)] overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse text-xs sm:text-sm">
            <thead>
              <tr className="bg-[#161224] border-b border-purple-900/50 text-gray-300 font-bold uppercase tracking-wider text-[11px]">
                ...
                filteredList.map(student => {
                  ...
                  return (
                    <tr
                      key={student.id}
                      onClick={() => setSelectedStudent(student)}
                      className="hover:bg-purple-950/25 transition-colors cursor-pointer group"
                    >
                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex items-center gap-3">
                          <img
                            src={student.photoUrl}
                            alt={student.fullName}
                            className="w-10 h-10 rounded-full object-cover border border-[#FBBF24]/50 group-hover:scale-105 transition-transform shrink-0"
                          />
                          <div>
                      ...
                      <td className="py-3.5 px-4 whitespace-nowrap">
                        <span className="font-mono font-bold text-white bg-purple-950/60 px-2.5 py-1 rounded border border-purple-800/40">
                          {student.roll}
                        </span>
                      </td>
                      ...
                      <td className="py-3.5 px-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <span className="px-2 py-0.5 rounded bg-[#1C162E] text-[#FBBF24] font-bold text-xs border border-purple-700/50">
                            {student.jerseySize}
                          </span>
      ...
      {selectedStudent && (
        ...
        >
          <div
            ...
            className="bg-[#120F1D] border-2 border-[#FBBF24] rounded-2xl max-w-lg w-full p-4 sm:p-6 text-left shadow-[0_0_50px_rgba(251,191,36,0.4)] relative cursor-default animate-in fade-in zoom-in duration-300 max-h-[92dvh] overflow-y-auto"
          >
            {/* Header */}
            <div className="flex justify-between items-start pb-3 border-b border-purple-900/50">
              <div>
                <span className="text-[10px] font-black text-[#FBBF24] uppercase tracking-widest block">
            ...
            {/* Pass Body */}
            <div className="my-4 sm:my-5 p-3.5 sm:p-4 rounded-xl bg-[#090710] border border-purple-800/60 space-y-3 sm:space-y-4">
              <div className="flex items-center gap-3 sm:gap-4">
                <img
                  src={selectedStudent.photoUrl}
                  alt={selectedStudent.fullName}
                  className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl object-cover border-2 border-[#FBBF24] shadow-[0_0_15px_rgba(251,191,36,0.3)] shrink-0"
                />
              ...
              {/* Jersey Specs */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs bg-[#120F1F] p-3 rounded-lg border border-purple-950/60">
                <div>
                  ...
                  <p className="text-[#FBBF24] font-bold">Size: {selectedStudent.jerseySize}</p>
                </div>
                <div>
              ...
              <div className="pt-2 flex items-center justify-between border-t border-purple-900/40">
                <div className="flex items-center gap-2 text-gray-300 text-xs font-mono">
                  <QrCode className="w-6 h-6 sm:w-7 sm:h-7 text-[#FBBF24] shrink-0" />
                  <div>
